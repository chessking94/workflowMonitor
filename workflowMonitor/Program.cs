...
namespace workflowMonitor
{
    class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            Console.ReadKey();
#else
            modLogging.AddLog("workflowMonitor", "C#", "Program.Main", modLogging.eLogLevel.INFO, "Process started", modLogging.eLogMethod.DATABASE);
#endif
...
#endif
                modLogging.AddLog("workflowMonitor", "C#", "Program.Main", modLogging.eLogLevel.CRITICAL, $"{ex.Message} --- {ex.StackTrace}", logMethod);
            }

#if !DEBUG
            modLogging.AddLog("workflowMonitor", "C#", "Program.Main", modLogging.eLogLevel.INFO, "Process ended", modLogging.eLogMethod.DATABASE);
#endif
        }
